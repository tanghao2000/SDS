...
if __name__ == "__main__":
    ...
    parser.add_argument("--cam_out_dir", default="./voc_cam/cam", type=str)
    parser.add_argument("--pseudo_mask_save_path", default="./voc_pl", type=str)
    parser.add_argument("--split_file", default="./voc12/train", type=str)
    parser.add_argument("--cam_eval_thres", default=2, type=float)
    parser.add_argument("--gt_root", default="./gen_voc/mask", type=str)
    parser.add_argument("--image_root", default="./gen_voc/image", type=str)
